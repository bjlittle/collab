...
# tmp.save(f"mesh_{step}.vtk")
tmp = pv.read(f"vtk/mesh_{step}.vtk")
p.add_mesh_clip_plane(tmp, widget_color="white", normal="z", crinkle=False, outline_opacity=0, name="plume", cmap=cmap, scalar_bar_args=sargs, show_edges=show_edges, above_color=rgb(206, 48, 255))
p.add_coastlines()
